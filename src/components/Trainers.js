...
import maleTrainer from "../images/maleTrainer.svg";
        ...
        <table className="trainerProfile">
          <tr>
            <td className="trainerImage">
              <img src={maleTrainer} alt="maleTrainer" className="profilePic" />
            </td>
            <td className="trainerDetails">
              <h2 className="trainerName">{this.props.trainerName}</h2>
